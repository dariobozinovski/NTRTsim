...
public:
   ...
   */
  LengthControllerYAML(double startTime, double minLength, double rate,double jumpTime,double jumpdelay,double extra1,double exra2,double extra3,
  ...
  void reset(); // This method will reset internal state variables
  void nextStep();//This method will change the parameters of the actuator for next step 
protected:
...
private:
  ...
  bool Ijumped;
  //need bool to decide when to jump
