...
def add_line_to_sh_file(file_path,iterator):
    ...
    jump_time =6
    jump_delay=0
    jump_extra1=round(0.5-0.025*iterator,3)
    jump_extra2=0.5
    jump_extra3=0.5  
    # for i in range(21):
    #     jump_extra2=round(0.5-0.025*i,3)
    #     for j in range(21):
    ...
    for i in range(21):
        ...
        # Command format
        command = f"./AppisocDarYAMLdirpret /home/ubuntu/NTRTsim/src/dev/dariostuff/models/isodrop3Aextalligned.yaml {start_time} {min_length} {rate} {jump_time} {jump_delay} {jump_extra1} {jump_extra2}\n"
        # Append the new command to the file
        with open(file_path, 'a') as file:
            file.write(command)
        print("New command added to the shell script.")
